...
## Table of Contents
<!-- TOC START -->
- [Dependency Injection and writing testable code](#dependency-injection-and-writing-testable-code)
  - [The Google Guide on Writing Testable Code](#the-google-guide-on-writing-testable-code)
    - [Related](#related)
  - [DIY DI by Chad Parry](#diy-di-by-chad-parry)
  - [Testing Through the Domain: the example (Anders Sveen)](#testing-through-the-domain-the-example-anders-sveen)
    - [Related](#related-1)
    - [My presentation on Tests You Can Trust](#my-presentation-on-tests-you-can-trust)
- [Generating test data](#generating-test-data)
  - [What if you just want to change one of the default fields slightly?](#what-if-you-just-want-to-change-one-of-the-default-fields-slightly)
