...
public class TradingInjector {
	...
	public static BookingService injectBookingService(String[] args) {
		return new BookingService(
				...
				injectTrade(args),
				injectSettlementAmountProvider(args));
	}
	
	public static Provider<BigDecimal> injectSettlementAmountProvider(final String[] args) {
		return new Provider<BigDecimal>() {
			public BigDecimal get() {
				return injectSettlementAmount(args);
			}
		};
	}
	...
	public static Provider<BigDecimal> injectPriceProvider(final String[] args) {
		return new Provider<BigDecimal>() {
			public BigDecimal get() {
